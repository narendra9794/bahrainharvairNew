$(function () {
	...
	var options = {
		...
		colors: ["rgba(87, 199, 224, 1)", '#0c971a'],
		title: {
			text: 'Clients Check-in',
			align: 'left',
			style: {
				fontSize: "16px",
				color: '#262626'
	...
	var options = {
		series: [{
			name: 'Net Profit',
			data: [44, 55, 57, 56, 61, 58, 63, 60, 66, 57, 56, 61, 58, ]
		},],
		chart: {
			foreColor: '#9ba7b2',
			type: 'bar',
		...
		colors: ["rgba(254, 195, 42, 1)", 'rgba(254, 195, 42, 1)', 'rgba(254, 195, 42, 1)'],
		xaxis: {
			categories: ['Outlet1', 'Outlet2', 'Outlet3', 'Outlet4', 'Outlet5', 'Outlet6', 'Outlet7', 'Outlet8', 'Outlet9', 'Outlet10', 'Outlet11', 'Outlet12'],
		},
		fill: {
			opacity: 1
		},
  ...
  plotOptions: {
    radialBar: {
      ...
      track: {
        background: 'rgba(112, 129, 190, 1)', // Change background color
      },
    },
  },
  colors: ['rgba(87, 199, 224, 1)'], // Set the radial bar color
  labels: ['Total Clients'],

  // Adding an annotation to act as an indicator
  annotations: {
    radialBar: {
      // Position the indicator inside the radial bar
      position: 'front',
      offsetY: -10, // Adjust this value to move the indicator
      offsetX: 0,
      annotations: [{
        text: {
          // Text for the indicator
          text: '60%', // You can dynamically set this based on value
          fontSize: '18px',
          fontWeight: 600,
          color: '#262626',
        },
        // You can customize the styling of the indicator here
        position: 'center',
      }]
    }
  }
